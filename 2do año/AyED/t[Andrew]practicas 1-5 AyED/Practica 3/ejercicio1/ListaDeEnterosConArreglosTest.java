...
public class ListaDeEnterosConArreglosTest {
	...
	public void testComenzar() {
		...
		l.agregar(0, 0);
		l.comenzar();
		assertEquals(new Integer(0), (Integer)l.elemento());
		...
		l.agregar(2, 0);
		l.comenzar();
		assertEquals(new Integer(2), (Integer)l.elemento());
	...
	public void testProximo() {
		...
		l.comenzar();
		for (int i = 0; i < 100; i++) {
			assertEquals((int)(new Integer(i)), l.elemento());
			l.proximo();
		}
		assertTrue(l.fin());
	...
	public void testElementoInt() {
		for (int i = 0; i < 100; i++)
			l.agregar(i, i);
		for (int i = 99; i >= 0; i--)
			assertEquals((int)(new Integer(i)), l.elemento(i));
	}
	...
	public void testAgregar() {
		...
		assertEquals(new Integer(2), (Integer)l.elemento(0));
		assertEquals(1, l.tamanio());
		
		//Test de agregar al principio cuando hay algo
		assertTrue(l.agregar(0, 0));
		assertEquals(new Integer(0), (Integer)l.elemento(0));
		assertEquals(new Integer(2), (Integer)l.elemento(1));
		assertEquals(2, l.tamanio());
		
		//Test de agregar entremedio
		assertTrue(l.agregar(1, 1));
		assertEquals(new Integer(0), (Integer)l.elemento(0));
		assertEquals(new Integer(1), (Integer)l.elemento(1));
		assertEquals(new Integer(2), (Integer)l.elemento(2));
		...
		assertEquals(new Integer(1), (Integer)l.elemento(1));
		assertEquals(new Integer(2),(Integer) l.elemento(2));
		assertEquals(new Integer(3),(Integer) l.elemento(3));
	...
	public void testEliminar() {
		...
		for (int i = 0; i < l.tamanio(); i++)
			assertEquals(new Integer(i + 1),(Integer) l.elemento(i));
